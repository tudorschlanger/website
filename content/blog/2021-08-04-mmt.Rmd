...
What MMT proponents would have done is have the government run large deficits which can provide the necessary support to the unemployed. The only true limit to government spending is high inflation - other than that, the only constraints are undue, self-imposed limits that cannot be justified in economic terms.  
